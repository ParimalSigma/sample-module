...
namespace Analytics\FullStory\Helper;
...
/**
 * Class Data
 * @package Analytics\FullStory\Helper
 */
class Data extends AbstractHelper
{
     ...
     */
    const CONFIG_MODULE_IS_ENABLED = 'analytics_fullstory/general/enabled';

    /**
     * FullStory script ID config
     */
    const CONFIG_MODULE_SCRIPT_ID = "analytics_fullstory/general/fs_org";
